package com.kingsoft.spider.core.system.task;
    ...
    public void bbsSpider() {
        ...
        while (true) {
            ...
            if (num == 0 && spider.isExitWhenComplete()) {
                ...
                PropertiesUtils.writeData("spiderLastTime.properties", "extopiaBBS", String.valueOf(System.currentTimeMillis() / 1000));
                break;
            }
        }
    ...
    public void bExtopiaSpider() {
        ...
        while (true) {
            ...
            if (num == 0 && spider.isExitWhenComplete()) {
                ...
                PropertiesUtils.writeData("spiderLastTime.properties", "extopiaB", String.valueOf(System.currentTimeMillis() / 1000));
                break;
            }
        }
    ...
    public void bMatSpider() {
        ...
        while (true)
        {
            ...
            if (num == 0 && spider.isExitWhenComplete()) {
                ...
                PropertiesUtils.writeData("spiderLastTime.properties", "matB", String.valueOf(System.currentTimeMillis() / 1000));
                break;
            }
        }
    ...
    public void bXmqzSpider() {
        ...
        while (true) {
            ...
            if (num == 0 && spider.isExitWhenComplete()) {
                ...
                PropertiesUtils.writeData("spiderLastTime.properties", "xmqzB", String.valueOf(System.currentTimeMillis() / 1000));
                break;
            }
        }
    ...
    public void extopiaTiebaSpider() {
        ...
        while (true) {
            ...
            if (num == 0 && spider1.isExitWhenComplete()) {
                ...
                PropertiesUtils.writeData("spiderLastTime.properties", "extopiaTieba", String.valueOf(System.currentTimeMillis() / 1000));
                break;
            }
        }
    ...
    public void matTiebaSpider() {
        ...
        while (true) {
            ...
            if (num == 0 && spider1.isExitWhenComplete()) {
                ...
                PropertiesUtils.writeData("spiderLastTime.properties", "matTieba", String.valueOf(System.currentTimeMillis() / 1000));
                break;
            }
        }
...
//    @Scheduled(cron = "30 40 14 ? * WED")
    ...
    public void xmqzTiebaSpider() {
        ...
        while (true) {
            ...
            if (num == 0 && spider1.isExitWhenComplete()) {
                ...
                PropertiesUtils.writeData("spiderLastTime.properties", "xmqzTieba", String.valueOf(System.currentTimeMillis() / 1000));
                break;
            }
        }
    ...
    public void extopiaWeiboSpider() {
        ...
        PropertiesUtils.writeData("spiderLastTime.properties", "extopiaWeibo", String.valueOf(System.currentTimeMillis() / 1000));
    ...
    public void xmqzWeiboSpider() {
        ...
        PropertiesUtils.writeData("spiderLastTime.properties", "xmqzWeibo", String.valueOf(System.currentTimeMillis() / 1000));
    ...
    public void matWeiboSpider() {
        ...
        PropertiesUtils.writeData("spiderLastTime.properties", "matWeibo", String.valueOf(System.currentTimeMillis() / 1000));
    ...
    public void producerWeiboSpider() {
        ...
        PropertiesUtils.writeData("spiderLastTime.properties", " producerWeibo", String.valueOf(System.currentTimeMillis() / 1000));
